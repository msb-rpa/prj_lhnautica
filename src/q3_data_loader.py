...
Carrega todos os CSVs no PostgreSQL respeitando o schema criado na
Questao 2, sem tratamento previo dos dados (nulos e caracteres especiais
preservados). Idempotente: TRUNCATE antes de cada carga.
...
def load_csv_to_table(conn, csv_path: str, table_name: str) -> None:
    ...
    with conn.cursor() as cur:
        # TRUNCATE garante idempotencia: reexecutar o script nao duplica dados
        ...
        with open(csv_path, "r", encoding="utf-8") as f:
            ...
            # Buffer em memoria com as colunas de auditoria adicionadas a cada linha
            buffer = io.StringIO()
...
def load_all(conn, csv_dir: str) -> None:
    ...
    for csv_file in csv_files:
        ...
        try:
            ...
            # Erro isolado por tabela: desfaz so a transacao atual e segue com as demais
            conn.rollback()
